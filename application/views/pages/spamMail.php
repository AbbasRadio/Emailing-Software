...
<div class="row">
    <div class="col-sm-12">
        <div class="white-box">
            <h2 class="box-title">Spam Mails</h2>
                    ...
                    <tbody>
                        ...
                        foreach ($results as $value) { ?>
                            <tr>
                                ...
                                <td>
                                    <a href="<?=BASE_URL('DataController/Spam_Mail/'.$value->id.'/'.$value->spam_msg)?>" class="icon"><?php
                                        if($value->spam_msg == 1){ ?><i class="fa fa-inbox fa-2x"></i>
                                    <?php }?></a>
                                </td>
                            </tr>
                        <?php } ?>
